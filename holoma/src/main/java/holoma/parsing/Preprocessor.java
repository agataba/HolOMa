...
public class Preprocessor {
	 ...
	 */
	public static Set<Edge<String, Integer>> removeInvalidEdges (Set<Vertex<String, String>> vertices, Set<Edge<String, Integer>> edges, String ontName) {
		...
		OutputToFile out = new OutputToFile (500, "./src/main/resources/invalidEdges_"+ontName+".csv");
